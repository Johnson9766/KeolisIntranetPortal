export default class DepartmentNewsListing{
    ...
    <div class="col-12 col-md-6 col-lg-4">
            <a href="__KEY_URL_DETAILSPAGE__" class="w-100 float-start news-centre-box d-flex flex-column">
              <img class="news-centre-img" src="__KEY_URL_DEPTIMG__" />
              <div class="d-flex flex-column gap-2 news-centre-details text-color-primary-300">
                ...
                <p class="font-semibold text-size-22">__KEY_DATA_DEPTTITLE__</p>
              </div>
            </a>
          </div>
  ...
  <div class="w-100 float-start font-semibold py-3 d-flex justify-content-center px-3 px-lg-4">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item"><a class="disabled-link" aria-disabled="true">News</a></li>
        </ol>
      </nav>
    </div>
    ...
    <div class="container container-keolis px-3 px-lg-4 clearfix">
        <div class="w-100 float-start my-4">
            <div class="row gy-4" id="divDeptNewsListing">
