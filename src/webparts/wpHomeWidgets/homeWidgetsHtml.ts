export default class homeWidgetsHtml{
    ...
    public static singleAnnouncementSliderElementHtml = `<div class="swiper-slide announcement-swiper-slide d-flex flex-column-reverse flex-sm-row">
                ...
                public static singleNewsCentreElement=`<a href="/sites/__KEY_SITE_NAME__/SitePages/NewsDetails.aspx?&NewsID=__KEY_ID_NEWS__" class="swiper-slide news-centre-box d-flex flex-column">
