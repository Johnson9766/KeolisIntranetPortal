export default class deptNewsDetails{

    public static deptsingleElementHtml:string=`   <div class="row d-flex align-items-center gy-4">
         ...
         public static deptsingleElementNewsDescription:string=` <p>__KEY_DATA_NEWSDECRIPTION__</p>
        `

    public static deptremainingNewsHtml:string=`<div class="col-12 col-lg-4" onclick="window.location.href='__KEY_URL_NEWSDETAILS__'" style="cursor: pointer;">
...
public static deptallElementsHtml:string=` <div class="main-wrapper min-h-screen-container">
    ...
    <div class="w-100 float-start font-semibold py-3 d-flex justify-content-center px-3 px-lg-4">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item"><a href="/sites/__KEY_SITE_NAME__/SitePages/DeptNewsListing.aspx?dept=__KEY_DEPT_NAME__" >News</a></li>
          <li class="breadcrumb-item"><a class="disabled-link" aria-disabled="true">News Details</a></li>
        </ol>
      </nav>
    </div>

      <div class="container container-keolis px-3 px-lg-4 clearfix">
        <div class="w-100 float-start my-4 py-1" id="deptActiveNews">
    ...
    <div class="w-100 float-start inner-page-wrapper">
      <div class="container container-keolis px-3 px-lg-4 clearfix">
          <div class="w-100 float-start mb-4 text-base font-normal news-details-para keolis-text-secondary"  id="deptNewsDescription">

                </div>
     
        <div class="w-100 float-start mb-4">
            <div class="row" id="deptRemainingNewsElements">
