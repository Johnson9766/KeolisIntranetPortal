    ...
    <div class="w-100 float-start font-semibold py-3 d-flex justify-content-center px-3 px-lg-4">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item"><a href="/sites/__KEY_SITE_NAME__/SitePages/DeptAnnoListing.aspx?dept=__KEY_DEPT_NAME__">Announcements</a></li>
          <li class="breadcrumb-item"><a aria-disabled="true" class="disabled-link">Announcement Details</a></li>
        </ol>
      </nav>
    </div>
